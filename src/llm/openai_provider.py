...
class OpenRouterProvider:
    ...
    Configuration precedence (highest to lowest):
      ...
      2) Environment variables (OPENAI_API_KEY, OPENAI_BASE_URL, OR_APP_URL, OR_APP_NAME)
    ...
    def from_config(cls, cfg: Dict[str, object]) -> "OpenRouterProvider":
        ...
        Supported keys under cfg:
          - api_key (NOT recommended in files) or api_key_env (env var name holding the key; default OPENAI_API_KEY)
          - base_url
          - model
          - system_prompt
          - temperature
        ...
        api_key = os.environ.get(api_key_env) or os.environ.get("OPENAI_API_KEY") or (cfg.get("api_key") or None)  # type: ignore
